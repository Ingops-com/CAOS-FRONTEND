...
function RecipeForm({ showFormRecipes }) {

    const { createRecipes } = useContext(ProductionContext)
    ...
    function handleSubmit(e) {
        ...
        createRecipes(name.toUpperCase(), description)
    }

    return (
        <CSSTransition nodeRef={nodeRef} in={showFormRecipes} timeout={200} classNames="" unmountOnExit appear={true}
            onEnter={() => { }}
        >
