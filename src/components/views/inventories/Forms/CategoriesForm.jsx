...
function categoriesForm({showFormCategorie}) {

    const nodeRef = useRef(null);
    const { createCategorie } = useContext(CategoriesContext)
    const { setShowFormEdit, setshowFormNew, setShowFormCategorie} = useContext(InventoriesContext)
    ...
    return (
        <CSSTransition nodeRef={nodeRef} in={showFormCategorie} timeout={200} classNames="container" unmountOnExit appear={true}
