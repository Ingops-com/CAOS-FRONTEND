...
function EditForm({ showFormEdit }) {
    ...
    const { ShowFormEdit, setShowFormEdit, itemsEditData, setItemsEditData, editItemById } = useContext(InvoicesContext)
                ...
                <form onSubmit={editItem} className="flex gap-3 p-5 justify-center items-center">
                    <div className="relative">
                        <input
                            ...
                            onChange={(e) => setItemsEditData({ ...itemsEditData, name: e.target.value })} // Permitir la edición
